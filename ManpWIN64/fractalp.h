...
extern	int	init_sin_df();
extern	int	do_sin_df();
extern	int	init_newton_df();
extern	int	do_newton_df();
extern	int	init_Magnet1();
extern	int	do_Magnet1();
extern	int	init_Magnet2();
extern	int	do_Magnet2();
extern	int	init_Teddy();
extern	int	do_Teddy();
extern	int	init_NewtonFigure8();
extern	int	do_NewtonFigure8();
extern	int	init_NewtonJuliaNova();
extern	int	do_NewtonJuliaNova();
extern	int	init_Talis();
extern	int	do_Talis();
extern	int	init_NewtonFlower();
extern	int	do_NewtonFlower();
extern	int	init_NewtonMSet();
extern	int	do_NewtonMSet();
extern	int	init_NewtonApple();
extern	int	do_NewtonApple();
extern	int	init_NewtonCross();
extern	int	do_NewtonCross();
extern	int	init_Quartet1();
extern	int	do_Quartet1();
extern	int	init_Quartet2();
extern	int	do_Quartet2();
extern	int	init_Quartet3();
extern	int	do_Quartet3();
extern	int	init_RamonSin();
extern	int	do_RamonSin();
extern	int	init_RamonCos();
extern	int	do_RamonCos();
extern	int	init_Formula_05();
extern	int	do_Formula_05();
extern	int	init_Sharon();
extern	int	do_Sharon();
extern	int	init_Quad();
extern	int	do_Quad();
extern	int	init_NewtonVariation();
extern	int	do_NewtonVariation();
extern	int	init_Nova();
extern	int	do_Nova();
extern	int	mountain();
extern	int	DoPoly();
extern	int	InitTalisPower();
extern	int	doTalisPower();
//extern	int	DoPopcornFractal();
extern	int	do_exp_df();
//extern	int	do_sin_df();
extern	int	do_mandel_df();
//extern	int	do_mandel4_df();
//extern	int	do_cubic_df();
extern	int	do_power_df();
extern	int	do_NewtonPolygon();
//extern	int	do_Newton5thOrder();
extern	int	do_SpecialNewton_df();
extern	int	do_matein_df();
extern	int	do_ratmap_df();
//extern	int	init_cubic_df();
extern	int	init_sin_df();
extern	int	init_power_df();
extern	int	init_NewtonPolygon();
//extern	int	init_Newton5thOrder();
extern	int	init_mandel_df();
extern	int	init_SpecialNewton_df();
extern	int	init_matein_df();
extern	int	init_ratmap_df();
extern	int	TestSetup();
extern	int	UnityFPSetup();
//extern		SierpinskiFPSetup();
//extern	int	SpiderFPSetup();
extern	int	BarnsleySetup();
extern	int	LambdaFPSetup();
extern	int	TrigSetup();
...
extern	int	DoPhoexnixFractal();
extern	int	DoPhoexnixComplex();
extern	int	DoZXTrigPlusZfpFractal();
...
extern	int	MandelFnSetup();
extern	int	LambdaTrigfp();
extern	int	HyperComplexFPFractal();
extern	int	InitHyperComplexFP();
...
extern	int	do_power_int(), init_power_int();
extern	int	InitComplexNewton();
extern	int	ComplexNewton();
extern	int	ComplexBasin();
//extern	int	ManOWarfpFractal();
extern	int	InitMostFracfp();
//extern	int	ManOWarfpFractal();

extern	int	do_exp_fl();
extern	int	do_sin_fl();
extern	int	do_cubic_fl();
extern	int	do_ratmap_fl();
extern	int	do_newton_fl();
extern	int	do_mandel_fl();
...
/*
extern	int	InitBifurcVerhulst();
extern	int	InitBifurcLambda();
extern	int	InitBifurcAddSinPi();
extern	int	InitBifurcSetSinPi();
extern	int	InitBifurcStewart();
extern	int	InitBifurcMay();
*/
...
extern	int	PhoenixSetup();
extern	int	MandPhoenixSetup();

extern	int	MandelfpSetup();

extern	int	init_cubic_fl();
extern	int	init_sin_fl();
extern	int	init_ratmap_fl();
extern	int	init_newton_fl();
extern	int	init_mandel_fl();
extern	int	init_RedShiftRider();
//extern	int	Formula();
extern	int	cellular();
extern	int	PhoenixCplxSetup();
...
extern	int	DoHenon();
//extern	int	DoMalthus();
//extern	int	DoTriangle();
//extern	int	DoGeometry();
//extern	int	DoLiterature();
//extern	int	DoCircle();
//extern	int	DoIkeda();
//extern	int	DoCrossRoads();
//extern	int	DoPascal();
extern	int	DoApollonius();
//extern	int	DoApolloniusIFS();
//extern	int	DoSierpinskiFlower();
//extern	int	DoZigzag();
//extern	int	DoGargoyles();
//extern	int	DoCurlicues();
//extern	int	DoChuaFlight();
extern	int	DoBurningShip();
extern	int	DoBurningShipPower();
//extern	int	DoThorn();
extern	int	DoRedShiftRider();
extern	int	StrangeAttractor();
//extern	int	plasma();
extern	int	DoIkeda2DExtra();
extern	int	DoKleinian();
extern	int	InitKleinian();
extern	int	DoSlope();
extern	int	DoSlopeFractal();
extern	int	InitSlopeFractal();
extern	int	InitPolynomial();
extern	int	doPolynomial();
//extern	int	DoSlope2();

/*
// Marcus mandelbrot derivatives
extern	int	DoMarcusCelite2();
extern	int	DoMarcusCelite4();
extern	int	DoMarcusCoreidra();
extern	int	DoMarcusCosseno();
extern	int	DoMarcusChromosome();
extern	int	DoMarcusEscher();
extern	int	DoMarcusEscher2();
extern	int	DoMarcusFranjas3();
extern	int	DoMarcusInsecRe();
extern	int	DoMarcusJupiters();
extern	int	DoMarcusLencos();
extern	int	DoMarcusLimits();
extern	int	DoMarcusMandelPalms();
extern	int	DoMarcusManpeito();
extern	int	DoMarcusMillor();
extern	int	DoMarcusMulherga();
extern	int	DoMarcusNovo();
extern	int	DoMarcusOmelette();
extern	int	DoMarcusOmelette();
extern	int	DoMarcusOssoDur();
extern	int	DoMarcusPassaros();
extern	int	DoMarcusPrumos();

extern	int	DoMarcusMandala();
//extern	int	DoMarcusWaterfall();
*/
/*
// mandelbrot derivatives
extern	int	DoPerpMandelbrot();
extern	int	DoPerpBurningShip();
extern	int	DoPerpBuffalo();
extern	int	DoBuffalo();
//extern	int	DoPopcorn();
extern	int	DoMandelbar();
extern	int	DoCeltic();
extern	int	DoMandelbarCeltic();
extern	int	DoPerpCeltic();
extern	int	DoCubicFlyingSquirrel();
extern	int	DoHeartMandelbrot();

// mandelbrot cubics
extern	int	DoCelticHeart();
extern	int	DoPartialCubicBurningShipReal();
extern	int	DoPartialCubicBurningShipImag();
extern	int	DoPartialCubicBuffaloReal();
extern	int	DoCubicQuasiBurningShip();
extern	int	DoCubicQuasiPerpendicular();
extern	int	DoCubicQuasiHeart();

// mandelbrot quartics
extern	int	DoMandelbrot4thOrder();
extern	int	DoMandelbar4thOrder();
extern	int	DoBurningShip4thOrder();
extern	int	DoBurningShip4thPartImag();
extern	int	DoBurningShip4thPartReal();
extern	int	DoBurningShip4thPartRealMbar();
extern	int	DoCelticBurningShip4th();
extern	int	DoCelticBurningShip4thPartImag();
extern	int	DoCelticBurningShip4thPartReal();
extern	int	DoCelticBurningShip4thPartRealMbar();
extern	int	DoBuffalo4th();
extern	int	DoBuffalo4thPartImag();
extern	int	DoCelticBuffalo4thPartReal();
extern	int	DoCeltic4thMbar();
extern	int	DoFalseQuasiPerp4th();
extern	int	DoFalseQuasiHeart4th();
extern	int	DoCelticFalseQuasiPerp4th();
extern	int	DoCelticFalseQuasiHeart4th();
extern	int	DoImagQuasiPerpHeart4th();
extern	int	DoRealQuasiPerp4th();
extern	int	DoRealQuasiHeart4th();
extern	int	DoCelticImagQuasiPerpHeart4th();
extern	int	DoCelticRealQuasiPerp4th();
extern	int	DoCelticRealQuasiHeart4th();

// mandelbrot Quintics
extern	int	DoMandelbrot5thOrder();
extern	int	DoMandelbar5thOrderVert();
extern	int	DoMandelbar5thOrderHor();
extern	int	DoBurningShip5thOrder();
extern	int	DoBuffalo5thOrder();
extern	int	DoBurningShip5thPartial();
extern	int	DoBurningShip5thPartialMbar();
extern	int	DoCeltic5thBuffalo5thPartial();
extern	int	DoCeltic5thMbar();
extern	int	DoQuaziBurningShip5thBSBuffaloHybrid();
extern	int	DoQuaziPerpendicular5th();
extern	int	DoQuaziHeart5th();

// mandelbrot Others
extern	int	DoSimonBrot();
extern	int	DoSimonBrot2();
extern	int	DoKungFuPanda();
extern	int	DoHPDZ_Buffalo();
extern	int	DoSzegediButterfly1();
extern	int	DoSzegediButterfly2();
*/
// Chaotic Oscillators
...
extern	int	DoLorenz();
//extern	int	DoLorenzMod1();
extern	int	DoAizawa();
//extern	int	DoThomasVar0();
//extern	int	DoThomasVar1();
//extern	int	DoThomasVar2();
//extern	int	DoThomasVar3();
//extern	int	DoThomasVar4();
//extern	int	DoThomasVar5();
//extern	int	DoThomasVar6();
extern	int	DoThomas();
...
//extern	int	DoHyperRosslerXY();
//extern	int	DoHyperRosslerXW();
//extern	int	DoHyperRosslerYW();
...
//extern	int	DoNewChaos1();
//extern	int	DoNewChaos2();
...
extern	int init_Formula_01();
extern	int do_Formula_01();
//extern	int Formula_02();
extern	int init_Formula_03();
extern	int do_Formula_03();
//extern	int Formula_04();
//extern	int Formula_05();
extern	int init_Formula_06();
extern	int do_Formula_06();
extern	int init_Formula_07();
extern	int do_Formula_07();
extern	int init_Formula_08();
extern	int do_Formula_08();
extern	int init_Formula_09();
extern	int do_Formula_09();
extern	int init_Formula_10();
extern	int do_Formula_10();
extern	int init_Formula_11();
extern	int do_Formula_11();
extern	int init_Formula_12();
extern	int do_Formula_12();
extern	int init_Formula_13();
extern	int do_Formula_13();
extern	int init_Formula_14();
extern	int do_Formula_14();
extern	int init_Formula_15();
extern	int do_Formula_15();
extern	int init_Formula_16();
extern	int do_Formula_16();
extern	int init_Formula_17();
extern	int do_Formula_17();
extern	int init_Formula_18();
extern	int do_Formula_18();
extern	int init_Formula_19();
extern	int do_Formula_19();
extern	int init_Formula_20();
extern	int do_Formula_20();
extern	int init_Formula_21();
extern	int do_Formula_21();
extern	int init_Formula_22();
extern	int do_Formula_22();
extern	int init_Formula_23();
extern	int do_Formula_23();
extern	int init_Formula_24();
extern	int do_Formula_24();
extern	int init_Formula_25();
extern	int do_Formula_25();
extern	int init_Formula_26();
extern	int do_Formula_26();
extern	int init_Formula_27();
extern	int do_Formula_27();
extern	int init_Formula_28();
extern	int do_Formula_28();
extern	int init_Formula_29();
extern	int do_Formula_29();
extern	int init_Formula_30();
extern	int do_Formula_30();
extern	int init_Formula_31();
extern	int do_Formula_31();
extern	int init_Formula_32();
extern	int do_Formula_32();
extern	int init_Formula_33();
extern	int do_Formula_33();
extern	int init_Formula_34();
extern	int do_Formula_34();
extern	int init_Formula_35();
extern	int do_Formula_35();
extern	int init_Formula_36();
extern	int do_Formula_36();
extern	int init_Formula_37();
extern	int do_Formula_37();
extern	int init_Formula_38();
extern	int do_Formula_38();
extern	int init_Formula_39();
extern	int do_Formula_39();
extern	int init_Formula_40();
extern	int do_Formula_40();
extern	int init_Formula_41();
extern	int do_Formula_41();
extern	int init_Formula_42();
extern	int do_Formula_42();
extern	int init_Formula_43();
extern	int do_Formula_43();
extern	int init_Formula_44();
extern	int do_Formula_44();
extern	int init_Formula_45();
extern	int do_Formula_45();
extern	int init_Formula_46();
extern	int do_Formula_46();
//extern	int init_Formula_47();
//extern	int do_Formula_47();
extern	int init_Formula_48();
extern	int do_Formula_48();
extern	int init_Formula_49();
extern	int do_Formula_49();
extern	int init_Formula_50();
extern	int do_Formula_50();
extern	int init_Formula_51();
extern	int do_Formula_51();
extern	int init_Formula_52();
extern	int do_Formula_52();
extern	int init_Formula_53();
extern	int do_Formula_53();
extern	int init_Formula_54();
extern	int do_Formula_54();
extern	int init_Formula_55();
extern	int do_Formula_55();
extern	int init_Formula_56();
extern	int do_Formula_56();
extern	int init_Formula_57();
extern	int do_Formula_57();
extern	int init_Formula_58();
extern	int do_Formula_58();
extern	int init_Formula_59();
extern	int do_Formula_59();
extern	int init_Formula_60();
extern	int do_Formula_60();
extern	int init_Formula_61();
extern	int do_Formula_61();
extern	int init_Formula_62();
extern	int do_Formula_62();
extern	int init_Formula_63();
extern	int do_Formula_63();
extern	int init_Formula_64();
extern	int do_Formula_64();
extern	int init_Formula_65();
extern	int do_Formula_65();
extern	int init_Formula_66();
extern	int do_Formula_66();
extern	int init_Formula_67();
extern	int do_Formula_67();
extern	int init_Formula_68();
extern	int do_Formula_68();
extern	int init_Formula_69();
extern	int do_Formula_69();
extern	int init_Formula_70();
extern	int do_Formula_70();
extern	int init_Formula_71();
extern	int do_Formula_71();
extern	int init_Formula_72();
extern	int do_Formula_72();
extern	int init_Formula_73();
extern	int do_Formula_73();
extern	int init_Formula_74();
extern	int do_Formula_74();
extern	int init_Formula_75();
extern	int do_Formula_75();
extern	int init_Formula_76();
extern	int do_Formula_76();
extern	int init_Formula_77();
extern	int do_Formula_77();
extern	int init_Formula_78();
extern	int do_Formula_78();
extern	int init_Formula_79();
extern	int do_Formula_79();
extern	int init_Formula_80();
extern	int do_Formula_80();
extern	int init_Formula_81();
extern	int do_Formula_81();
extern	int init_Formula_82();
extern	int do_Formula_82();
extern	int init_Formula_83();
extern	int do_Formula_83();
extern	int init_Formula_84();
extern	int do_Formula_84();
extern	int init_Formula_85();
extern	int do_Formula_85();
extern	int init_Formula_86();
extern	int do_Formula_86();
extern	int init_Formula_87();
extern	int do_Formula_87();
extern	int init_Formula_88();
extern	int do_Formula_88();
extern	int init_Formula_89();
extern	int do_Formula_89();
extern	int init_Formula_90();
extern	int do_Formula_90();
extern	int init_Formula_91();
extern	int do_Formula_91();
extern	int init_Formula_92();
extern	int do_Formula_92();
extern	int init_Formula_93();
extern	int do_Formula_93();
extern	int init_Formula_94();
extern	int do_Formula_94();
extern	int init_Formula_95();
extern	int do_Formula_95();
extern	int init_Formula_96();
extern	int do_Formula_96();
extern	int init_Formula_97();
extern	int do_Formula_97();
extern	int init_Formula_98();
extern	int do_Formula_98();
extern	int init_Formula_99();
extern	int do_Formula_99();
extern	int init_Formula_100();
extern	int do_Formula_100();
extern	int init_Formula_101();
extern	int do_Formula_101();
extern	int init_Formula_102();
extern	int do_Formula_102();
extern	int init_Formula_103();
extern	int do_Formula_103();
extern	int init_Formula_104();
extern	int do_Formula_104();
extern	int init_Formula_105();
extern	int do_Formula_105();
extern	int init_Formula_106();
extern	int do_Formula_106();
extern	int init_Formula_107();
extern	int do_Formula_107();
extern	int init_Formula_108();
extern	int do_Formula_108();
extern	int init_Formula_109();
extern	int do_Formula_109();
extern	int init_Formula_110();
extern	int do_Formula_110();
extern	int init_Formula_111();
extern	int do_Formula_111();
extern	int init_Formula_112();
extern	int do_Formula_112();
extern	int init_Formula_113();
extern	int do_Formula_113();
extern	int init_Formula_114();
extern	int do_Formula_114();
extern	int init_Formula_115();
extern	int do_Formula_115();
extern	int init_Formula_116();
extern	int do_Formula_116();
extern	int init_Formula_117();
extern	int do_Formula_117();
extern	int init_Formula_118();
extern	int do_Formula_118();

// Flarium fractals (not covered by Tierazon)
extern	int init_Flarium_06();
extern	int do_Flarium_06();
extern	int init_Flarium_07();
extern	int do_Flarium_07();
extern	int init_Flarium_08();
extern	int do_Flarium_08();
extern	int init_Flarium_09();
extern	int do_Flarium_09();
extern	int init_Flarium_10();
extern	int do_Flarium_10();
extern	int init_Flarium_11();
extern	int do_Flarium_11();
extern	int init_Flarium_12();
extern	int do_Flarium_12();
extern	int init_Flarium_13();
extern	int do_Flarium_13();
extern	int init_Flarium_15();
extern	int do_Flarium_15();
extern	int init_Flarium_16();
extern	int do_Flarium_16();
extern	int init_Flarium_20();
extern	int do_Flarium_20();
extern	int init_Flarium_21();
extern	int do_Flarium_21();
extern	int init_Flarium_25();
extern	int do_Flarium_25();
extern	int init_Flarium_27();
extern	int do_Flarium_27();
extern	int init_Flarium_28();
extern	int do_Flarium_28();
extern	int init_Flarium_29();
extern	int do_Flarium_29();
extern	int init_Flarium_30();
extern	int do_Flarium_30();
extern	int init_Flarium_31();
extern	int do_Flarium_31();
extern	int init_Flarium_32();
extern	int do_Flarium_32();
extern	int init_Flarium_34();
extern	int do_Flarium_34();
extern	int init_Flarium_35();
extern	int do_Flarium_35();
extern	int init_Flarium_36();
extern	int do_Flarium_36();
extern	int init_Flarium_37();
extern	int do_Flarium_37();
extern	int init_Flarium_38();
extern	int do_Flarium_38();
extern	int init_Flarium_40();
extern	int do_Flarium_40();
extern	int init_Flarium_41();
extern	int do_Flarium_41();
extern	int init_Flarium_43();
extern	int do_Flarium_43();
extern	int init_Flarium_44();
extern	int do_Flarium_44();
extern	int init_Flarium_45();
extern	int do_Flarium_45();
extern	int init_Flarium_46();
extern	int do_Flarium_46();
extern	int init_Flarium_49();
extern	int do_Flarium_49();
extern	int init_Flarium_50();
extern	int do_Flarium_50();
extern	int init_Flarium_51();
extern	int do_Flarium_51();
extern	int init_Flarium_52();
extern	int do_Flarium_52();
extern	int init_Flarium_53();
extern	int do_Flarium_53();
extern	int init_Flarium_54();
extern	int do_Flarium_54();
extern	int init_Flarium_55();
extern	int do_Flarium_55();
extern	int init_Flarium_56();
extern	int do_Flarium_56();
extern	int init_Flarium_57();
extern	int do_Flarium_57();
extern	int init_Flarium_58();
extern	int do_Flarium_58();
extern	int init_Flarium_59();
extern	int do_Flarium_59();
extern	int init_Flarium_60();
extern	int do_Flarium_60();
extern	int init_Flarium_61();
extern	int do_Flarium_61();
extern	int init_Flarium_62();
extern	int do_Flarium_62();
extern	int init_Flarium_64();
extern	int do_Flarium_64();
extern	int init_Flarium_66();
extern	int do_Flarium_66();
extern	int init_Flarium_67();
extern	int do_Flarium_67();
extern	int init_Flarium_80();
extern	int do_Flarium_80();
extern	int init_Flarium_90();
extern	int do_Flarium_90();
extern	int init_Flarium_91();
extern	int do_Flarium_91();
extern	int init_Flarium_92();
extern	int do_Flarium_92();
extern	int init_Flarium_93();
extern	int do_Flarium_93();
extern	int init_Flarium_111();
extern	int do_Flarium_111();
extern	int init_Flarium_112();
extern	int do_Flarium_112();
extern	int init_Flarium_117();
extern	int do_Flarium_117();
extern	int init_Flarium_118();
extern	int do_Flarium_118();
extern	int init_Flarium_119();
extern	int do_Flarium_119();
extern	int init_Flarium_125();
extern	int do_Flarium_125();
extern	int init_Flarium_145();
extern	int do_Flarium_145();

// now the Bignum versions
extern	int init_big_Flarium_06();
extern	int do_big_Flarium_06();
extern	int init_big_Flarium_07();
extern	int do_big_Flarium_07();
extern	int init_big_Flarium_08();
extern	int do_big_Flarium_08();
extern	int init_big_Flarium_09();
extern	int do_big_Flarium_09();
extern	int init_big_Flarium_10();
extern	int do_big_Flarium_10();
extern	int init_big_Flarium_11();
extern	int do_big_Flarium_11();
extern	int init_big_Flarium_12();
extern	int do_big_Flarium_12();
extern	int init_big_Flarium_13();
extern	int do_big_Flarium_13();
extern	int init_big_Flarium_15();
extern	int do_big_Flarium_15();
extern	int init_big_Flarium_16();
extern	int do_big_Flarium_16();
extern	int init_big_Flarium_20();
extern	int do_big_Flarium_20();
extern	int init_big_Flarium_21();
extern	int do_big_Flarium_21();
extern	int init_big_Flarium_25();
extern	int do_big_Flarium_25();
extern	int init_big_Flarium_27();
extern	int do_big_Flarium_27();
extern	int init_big_Flarium_28();
extern	int do_big_Flarium_28();
extern	int init_big_Flarium_29();
extern	int do_big_Flarium_29();
extern	int init_big_Flarium_30();
extern	int do_big_Flarium_30();
extern	int init_big_Flarium_31();
extern	int do_big_Flarium_31();
extern	int init_big_Flarium_32();
extern	int do_big_Flarium_32();
extern	int init_big_Flarium_34();
extern	int do_big_Flarium_34();
extern	int init_big_Flarium_35();
extern	int do_big_Flarium_35();
extern	int init_big_Flarium_36();
extern	int do_big_Flarium_36();
extern	int init_big_Flarium_37();
extern	int do_big_Flarium_37();
extern	int init_big_Flarium_38();
extern	int do_big_Flarium_38();
extern	int init_big_Flarium_40();
extern	int do_big_Flarium_40();
extern	int init_big_Flarium_41();
extern	int do_big_Flarium_41();
extern	int init_big_Flarium_43();
extern	int do_big_Flarium_43();
extern	int init_big_Flarium_44();
extern	int do_big_Flarium_44();
extern	int init_big_Flarium_45();
extern	int do_big_Flarium_45();
extern	int init_big_Flarium_46();
extern	int do_big_Flarium_46();
extern	int init_big_Flarium_49();
extern	int do_big_Flarium_49();
extern	int init_big_Flarium_50();
extern	int do_big_Flarium_50();
extern	int init_big_Flarium_51();
extern	int do_big_Flarium_51();
extern	int init_big_Flarium_52();
extern	int do_big_Flarium_52();
extern	int init_big_Flarium_53();
extern	int do_big_Flarium_53();
extern	int init_big_Flarium_54();
extern	int do_big_Flarium_54();
extern	int init_big_Flarium_55();
extern	int do_big_Flarium_55();
extern	int init_big_Flarium_56();
extern	int do_big_Flarium_56();
extern	int init_big_Flarium_57();
extern	int do_big_Flarium_57();
extern	int init_big_Flarium_58();
extern	int do_big_Flarium_58();
extern	int init_big_Flarium_59();
extern	int do_big_Flarium_59();
extern	int init_big_Flarium_60();
extern	int do_big_Flarium_60();
extern	int init_big_Flarium_61();
extern	int do_big_Flarium_61();
extern	int init_big_Flarium_62();
extern	int do_big_Flarium_62();
extern	int init_big_Flarium_64();
extern	int do_big_Flarium_64();
extern	int init_big_Flarium_66();
extern	int do_big_Flarium_66();
extern	int init_big_Flarium_67();
extern	int do_big_Flarium_67();
extern	int init_big_Flarium_80();
extern	int do_big_Flarium_80();
extern	int init_big_Flarium_90();
extern	int do_big_Flarium_90();
extern	int init_big_Flarium_91();
extern	int do_big_Flarium_91();
extern	int init_big_Flarium_92();
extern	int do_big_Flarium_92();
extern	int init_big_Flarium_93();
extern	int do_big_Flarium_93();
extern	int init_big_Flarium_111();
extern	int do_big_Flarium_111();
extern	int init_big_Flarium_112();
extern	int do_big_Flarium_112();
extern	int init_big_Flarium_117();
extern	int do_big_Flarium_117();
extern	int init_big_Flarium_118();
extern	int do_big_Flarium_118();
extern	int init_big_Flarium_119();
extern	int do_big_Flarium_119();
extern	int init_big_Flarium_125();
extern	int do_big_Flarium_125();
extern	int init_big_Flarium_145();
extern	int do_big_Flarium_145();

// now the Bignum versions
extern	int init_big_Formula_01();
extern	int do_big_Formula_01();
//extern	int Formula_02();
extern	int init_big_Formula_03();
extern	int do_big_Formula_03();
//extern	int Formula_04();
//extern	int Formula_05();
extern	int init_big_Formula_05();
extern	int do_big_Formula_05();
extern	int init_big_Formula_06();
extern	int do_big_Formula_06();
extern	int init_big_Formula_07();
extern	int do_big_Formula_07();
extern	int init_big_Formula_08();
extern	int do_big_Formula_08();
extern	int init_big_Formula_09();
extern	int do_big_Formula_09();
extern	int init_big_Formula_10();
extern	int do_big_Formula_10();
extern	int init_big_Formula_11();
extern	int do_big_Formula_11();
extern	int init_big_Formula_12();
extern	int do_big_Formula_12();
extern	int init_big_Formula_13();
extern	int do_big_Formula_13();
extern	int init_big_Formula_14();
extern	int do_big_Formula_14();
extern	int init_big_Formula_15();
extern	int do_big_Formula_15();
extern	int init_big_Formula_16();
extern	int do_big_Formula_16();
extern	int init_big_Formula_17();
extern	int do_big_Formula_17();
extern	int init_big_Formula_18();
extern	int do_big_Formula_18();
extern	int init_big_Formula_19();
extern	int do_big_Formula_19();
extern	int init_big_Formula_20();
extern	int do_big_Formula_20();
extern	int init_big_Formula_21();
extern	int do_big_Formula_21();
extern	int init_big_Formula_22();
extern	int do_big_Formula_22();
extern	int init_big_Formula_23();
extern	int do_big_Formula_23();
extern	int init_big_Formula_24();
extern	int do_big_Formula_24();
extern	int init_big_Formula_25();
extern	int do_big_Formula_25();
extern	int init_big_Formula_26();
extern	int do_big_Formula_26();
extern	int init_big_Formula_27();
extern	int do_big_Formula_27();
extern	int init_big_Formula_28();
extern	int do_big_Formula_28();
extern	int init_big_Formula_29();
extern	int do_big_Formula_29();
extern	int init_big_Formula_30();
extern	int do_big_Formula_30();
extern	int init_big_Formula_31();
extern	int do_big_Formula_31();
extern	int init_big_Formula_32();
extern	int do_big_Formula_32();
extern	int init_big_Formula_33();
extern	int do_big_Formula_33();
extern	int init_big_Formula_34();
extern	int do_big_Formula_34();
extern	int init_big_Formula_35();
extern	int do_big_Formula_35();
extern	int init_big_Formula_36();
extern	int do_big_Formula_36();
extern	int init_big_Formula_37();
extern	int do_big_Formula_37();
extern	int init_big_Formula_38();
extern	int do_big_Formula_38();
extern	int init_big_Formula_39();
extern	int do_big_Formula_39();
extern	int init_big_Formula_40();
extern	int do_big_Formula_40();
extern	int init_big_Formula_41();
extern	int do_big_Formula_41();
extern	int init_big_Formula_42();
extern	int do_big_Formula_42();
extern	int init_big_Formula_43();
extern	int do_big_Formula_43();
extern	int init_big_Formula_44();
extern	int do_big_Formula_44();
extern	int init_big_Formula_45();
extern	int do_big_Formula_45();
extern	int init_big_Formula_46();
extern	int do_big_Formula_46();
//extern	int init_big_Formula_47();
//extern	int do_big_Formula_47();
extern	int init_big_Formula_48();
extern	int do_big_Formula_48();
extern	int init_big_Formula_49();
extern	int do_big_Formula_49();
extern	int init_big_Formula_50();
extern	int do_big_Formula_50();
extern	int init_big_Formula_51();
extern	int do_big_Formula_51();
extern	int init_big_Formula_52();
extern	int do_big_Formula_52();
extern	int init_big_Formula_53();
extern	int do_big_Formula_53();
extern	int init_big_Formula_54();
extern	int do_big_Formula_54();
extern	int init_big_Formula_55();
extern	int do_big_Formula_55();
extern	int init_big_Formula_56();
extern	int do_big_Formula_56();
extern	int init_big_Formula_57();
extern	int do_big_Formula_57();
extern	int init_big_Formula_58();
extern	int do_big_Formula_58();
extern	int init_big_Formula_59();
extern	int do_big_Formula_59();
extern	int init_big_Formula_60();
extern	int do_big_Formula_60();
extern	int init_big_Formula_61();
extern	int do_big_Formula_61();
extern	int init_big_Formula_62();
extern	int do_big_Formula_62();
extern	int init_big_Formula_63();
extern	int do_big_Formula_63();
extern	int init_big_Formula_64();
extern	int do_big_Formula_64();
extern	int init_big_Formula_65();
extern	int do_big_Formula_65();
extern	int init_big_Formula_66();
extern	int do_big_Formula_66();
extern	int init_big_Formula_67();
extern	int do_big_Formula_67();
extern	int init_big_Formula_68();
extern	int do_big_Formula_68();
extern	int init_big_Formula_69();
extern	int do_big_Formula_69();
extern	int init_big_Formula_70();
extern	int do_big_Formula_70();
extern	int init_big_Formula_71();
extern	int do_big_Formula_71();
extern	int init_big_Formula_72();
extern	int do_big_Formula_72();
extern	int init_big_Formula_73();
extern	int do_big_Formula_73();
extern	int init_big_Formula_74();
extern	int do_big_Formula_74();
extern	int init_big_Formula_75();
extern	int do_big_Formula_75();
extern	int init_big_Formula_76();
extern	int do_big_Formula_76();
extern	int init_big_Formula_77();
extern	int do_big_Formula_77();
extern	int init_big_Formula_78();
extern	int do_big_Formula_78();
extern	int init_big_Formula_79();
extern	int do_big_Formula_79();
extern	int init_big_Formula_80();
extern	int do_big_Formula_80();
extern	int init_big_Formula_81();
extern	int do_big_Formula_81();
extern	int init_big_Formula_82();
extern	int do_big_Formula_82();
extern	int init_big_Formula_83();
extern	int do_big_Formula_83();
extern	int init_big_Formula_84();
extern	int do_big_Formula_84();
extern	int init_big_Formula_85();
extern	int do_big_Formula_85();
extern	int init_big_Formula_86();
extern	int do_big_Formula_86();
extern	int init_big_Formula_87();
extern	int do_big_Formula_87();
extern	int init_big_Formula_88();
extern	int do_big_Formula_88();
extern	int init_big_Formula_89();
extern	int do_big_Formula_89();
extern	int init_big_Formula_90();
extern	int do_big_Formula_90();
extern	int init_big_Formula_91();
extern	int do_big_Formula_91();
extern	int init_big_Formula_92();
extern	int do_big_Formula_92();
extern	int init_big_Formula_93();
extern	int do_big_Formula_93();
extern	int init_big_Formula_94();
extern	int do_big_Formula_94();
extern	int init_big_Formula_95();
extern	int do_big_Formula_95();
extern	int init_big_Formula_96();
extern	int do_big_Formula_96();
extern	int init_big_Formula_97();
extern	int do_big_Formula_97();
extern	int init_big_Formula_98();
extern	int do_big_Formula_98();
extern	int init_big_Formula_99();
extern	int do_big_Formula_99();
extern	int init_big_Formula_100();
extern	int do_big_Formula_100();
extern	int init_big_Formula_101();
extern	int do_big_Formula_101();
extern	int init_big_Formula_102();
extern	int do_big_Formula_102();
extern	int init_big_Formula_103();
extern	int do_big_Formula_103();
extern	int init_big_Formula_104();
extern	int do_big_Formula_104();
extern	int init_big_Formula_105();
extern	int do_big_Formula_105();
extern	int init_big_Formula_106();
extern	int do_big_Formula_106();
extern	int init_big_Formula_107();
extern	int do_big_Formula_107();
extern	int init_big_Formula_108();
extern	int do_big_Formula_108();
extern	int init_big_Formula_109();
extern	int do_big_Formula_109();
extern	int init_big_Formula_110();
extern	int do_big_Formula_110();
extern	int init_big_Formula_111();
extern	int do_big_Formula_111();
extern	int init_big_Formula_112();
extern	int do_big_Formula_112();
extern	int init_big_Formula_113();
extern	int do_big_Formula_113();
extern	int init_big_Formula_114();
extern	int do_big_Formula_114();
extern	int init_big_Formula_115();
extern	int do_big_Formula_115();
extern	int init_big_Formula_116();
extern	int do_big_Formula_116();
extern	int init_big_Formula_117();
extern	int do_big_Formula_117();
extern	int init_big_Formula_118();
extern	int do_big_Formula_118();

extern	int init_big_NewtonJuliaNova();
extern	int do_big_NewtonJuliaNova();
extern	int init_big_Talis();
extern	int do_big_Talis();
extern	int init_big_Sharon();
extern	int do_big_Sharon();
extern	int init_big_Quad();
extern	int do_big_Quad();
extern	int init_big_Magnet1();
extern	int do_big_Magnet1();
extern	int init_big_Magnet2();
extern	int do_big_Magnet2();
extern	int init_big_Teddy();
extern	int do_big_Teddy();

extern	int init_big_cubic();
extern	int do_big_cubic();
extern	int init_big_mandel();
extern	int do_big_power();
extern	int init_big_mandel();
extern	int do_big_mandel();
extern	int init_big_mandel();
extern	int do_big_mandel();
extern	int init_BigNewtonPolygon();
extern	int do_BigNewtonPolygon();
extern	int init_big_matein();
extern	int do_big_matein();
extern	int init_big_sin();
extern	int do_big_sin();
extern	int do_big_exp();
extern	int init_big_SpecialNewton();
extern	int do_big_SpecialNewton();
extern	int init_big_RedShiftRider();
extern	int Do_big_RedShiftRider();
extern	int InitBigTalisPower();
extern	int doBigTalisPower();
extern	int InitBigPolynomial();
extern	int doBigPolynomial();

extern	int init_big_NewtonApple();
extern	int do_big_NewtonApple();
extern	int init_big_NewtonFlower();
extern	int do_big_NewtonFlower();
extern	int init_big_NewtonMSet();
extern	int do_big_NewtonMSet();
extern	int init_big_NewtonCross();
extern	int do_big_NewtonCross();
extern	int init_big_Quartet1();
extern	int do_big_Quartet1();
extern	int init_big_Quartet2();
extern	int do_big_Quartet2();
extern	int init_big_Quartet3();
extern	int do_big_Quartet3();
extern	int init_big_RamonSin();
extern	int do_big_RamonSin();
extern	int init_big_RamonCos();
extern	int do_big_RamonCos();
extern	int init_big_Tierazon();
extern	int do_big_Tierazon();
extern	int init_big_MandelDeriv();
extern	int do_big_MandelDeriv();
extern	int init_big_Nova();
extern	int do_big_Nova();

// mandelbrot derivatives
extern	int do_big_BurningShip();
extern	int do_big_BurningShipPower();
extern	int Do_big_PerpMandelbrot();
extern	int Do_big_Buffalo();
extern	int Do_big_PerpBurningShip();
extern	int Do_big_Celtic();
extern	int Do_big_PerpCeltic();
extern	int Do_big_MandelbarCeltic();
extern	int Do_big_PerpBuffalo();
extern	int Do_big_Mandelbar();
extern	int Do_big_CubicFlyingSquirrel();
extern	int Do_big_HeartMandelbrot();
extern	int Do_big_CelticHeart();
extern	int Do_big_PartialCubicBurningShipReal();
extern	int Do_big_PartialCubicBurningShipImag();
extern	int Do_big_PartialCubicBuffaloReal();

// mandelbrot cubics
extern	int Do_big_CubicQuasiBurningShip();
extern	int Do_big_CubicQuasiPerpendicular();
extern	int Do_big_CubicQuasiHeart();

// mandelbrot quartics
extern	int Do_big_Mandelbrot4thOrder();
extern	int Do_big_Mandelbar4thOrder();
extern	int Do_big_BurningShip4thOrder();
extern	int Do_big_BurningShip4thPartImag();
extern	int Do_big_BurningShip4thPartReal();
extern	int Do_big_BurningShip4thPartRealMbar();
extern	int Do_big_CelticBurningShip4th();
extern	int Do_big_CelticBurningShip4thPartImag();
extern	int Do_big_CelticBurningShip4thPartReal();
extern	int Do_big_CelticBurningShip4thPartRealMbar();
extern	int Do_big_Buffalo4th();
extern	int Do_big_Buffalo4thPartImag();
extern	int Do_big_CelticBuffalo4thPartReal();
extern	int Do_big_Celtic4thMbar();
extern	int Do_big_FalseQuasiPerp4th();
extern	int Do_big_FalseQuasiHeart4th();
extern	int Do_big_CelticFalseQuasiPerp4th();
extern	int Do_big_CelticFalseQuasiHeart4th();
extern	int Do_big_ImagQuasiPerpHeart4th();
extern	int Do_big_RealQuasiPerp4th();
extern	int Do_big_RealQuasiHeart4th();
extern	int Do_big_CelticImagQuasiPerpHeart4th();
extern	int Do_big_CelticRealQuasiPerp4th();
extern	int Do_big_CelticRealQuasiHeart4th();

// mandelbrot Quintics
extern	int Do_big_Mandelbrot5thOrder();
extern	int Do_big_Mandelbar5thOrderVert();
extern	int Do_big_Mandelbar5thOrderHor();
extern	int Do_big_BurningShip5thOrder();
extern	int Do_big_Buffalo5thOrder();
extern	int Do_big_BurningShip5thPartial();
extern	int Do_big_BurningShip5thPartialMbar();
extern	int Do_big_Celtic5thBuffalo5thPartial();
extern	int Do_big_Celtic5thMbar();
extern	int Do_big_QuaziBurningShip5thBSBuffaloHybrid();
extern	int Do_big_QuaziPerpendicular5th();
extern	int Do_big_QuaziHeart5th();

extern	int Do_big_SimonBrot();
extern	int Do_big_SimonBrot2();
extern	int Do_big_KungFuPanda();
extern	int Do_big_HPDZ_Buffalo();
